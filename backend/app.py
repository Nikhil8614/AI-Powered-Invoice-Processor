...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:Sainikhil%40333@localhost:5432/flaskdb'
...
class Users(db.Model):
    ...
    aadhar_file = db.Column(db.String(255), nullable=False)  # Path to stored Aadhar file
...
def signup():
    ...
    try:
        ...
        new_user = Users(
            ...
            aadhar_file=db_aadhar_path,
            pan_file=db_pan_path
        )
